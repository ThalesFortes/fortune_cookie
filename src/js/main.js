//Váriaveis
const messages = new Array ('A vida trará coisas boas se tiver paciência.',
...
//Funções
function getMessageRandom() {
  // Gera um número aleatório entre 0 e o comprimento da matriz messages
  const randomIndex = Math.round(Math.random() * messages.length);
  // Retorna a mensagem e o índice correspondente ao índice aleatório
  return  { index: randomIndex, message: messages[randomIndex] };
}
